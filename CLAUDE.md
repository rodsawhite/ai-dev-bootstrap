...
This is a bootstrap repository for setting up Windows systems for AI-assisted development. It installs WSL2, Ubuntu, Docker Desktop, VS Code, and multiple AI coding agents (Claude Code, Gemini CLI, OpenCode, Codex CLI, GitHub Copilot CLI, Aider, Ollama).
...
5. `install-ai-agents.sh` - Installs Claude Code, Gemini CLI, OpenCode, Codex CLI, Copilot CLI, Aider, Ollama
